...
A named memeory location to store data, which may get modified throughout the program execution. 

| Language | Variables Information |
|----------|-----------------------|
...
|-------------|------------------------------------------------------|
| Initialization | the process of assigning the data/value to a variable is known as initialization|
